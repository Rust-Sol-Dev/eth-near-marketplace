...
# 🧧 Smarties NFT Marketplace Smart Contract on NEAR
...
> Market contract will use a cross contract call to the NFT contract which is deployed on `nft.smarties.near`. 
