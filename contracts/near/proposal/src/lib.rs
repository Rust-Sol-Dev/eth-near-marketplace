...
pub struct ProposalContract{
    ...
    pub proposals_by_id_collection_name: UnorderedMap<ProposalId, CollectionName>,
    pub proposals_by_id: UnorderedMap<ProposalId, Proposal>, //-- keeping track of all proposals related to a specific collection - all proposals' collection
}
...
impl ProposalContract{
    ...
    pub fn new(owner_id: AccountId) -> Self{
        Self{
            owner_id,
            proposals_by_id: UnorderedMap::new(StorageKey::ProposalById.try_to_vec().unwrap()),
            proposals_by_id_collection_name: UnorderedMap::new(StorageKey::ProposalByIdCollectionName.try_to_vec().unwrap()),
        }
    }    
