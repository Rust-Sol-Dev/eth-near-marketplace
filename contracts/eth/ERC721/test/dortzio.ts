...
import {
    DortzioNFT, DortzioNFT__factory, DortzioNFTFactory__factory,
    DortzioNFTFactory, DortzioNFTMarketplace__factory, DortzioNFTMarketplace,
...
describe("Dortzio Marketplace", () => {
    ...
    let nft: DortzioNFT;
    let factory: DortzioNFTFactory;
    let marketplace: DortzioNFTMarketplace;
    let owner: Signer;
    let creator: Signer;
    let buyer: Signer;
    let offerer: Signer;
    ...
    before(async () => {
        ...
        const Factory = new DortzioNFTFactory__factory(owner);
        ...
        nft = new ethers.Contract(collectionAddress, DortzioNFT__factory.abi, creator) as DortzioNFT;
